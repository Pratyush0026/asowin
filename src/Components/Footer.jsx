        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start pt-8 sm:pt-12 md:pt-16">
            ...
            <nav className="flex flex-wrap gap-4 sm:gap-6 md:gap-8 lg:gap-12 mt-6 sm:mt-16 md:mt-28 text-center md:text-left">
              <a href="/services" className="text-white hover:text-[#FFB842] text-sm font-semibold whitespace-nowrap">
                SERVICES
              </a>
              <a href="/our-book" className="text-white hover:text-[#FFB842] text-sm font-semibold  whitespace-nowrap">
                OUR BOOK
              </a>
              <a href="/blog" className="text-white hover:text-[#FFB842] text-sm font-semibold  whitespace-nowrap">
                BLOG
              </a>
              <a href="/about" className="text-white hover:text-[#FFB842] text-sm font-semibold  whitespace-nowrap">
                ABOUT
              </a>
              <a href="/contact" className="text-white hover:text-[#FFB842] text-sm font-semibold  whitespace-nowrap">
                CONTACT US
              </a>
            </nav>
          </div>
