...
// const KeywordStats = () => {
//   return (
//     <div className="w-full min-h-screen bg-orange-50 relative overflow-hidden p-4">
//       <div className="container mx-auto px-4 py-12">
//         <div className="max-w-4xl mx-auto text-center">
//           <h1 className="text-3xl md:text-4xl lg:text-[39px] font-medium font-serif text-[#1A1A1A] mb-6">
//             Rank Highest For Your Keywords
//           </h1>
          
//           <p className="text-[#1A1A1A] font-normal text-lg md:text-xl mb-12 max-w-3xl mx-auto">
...
//             <div className="bg-white w-[285px] h-[273px] rounded-lg shadow-lg relative flex flex-col items-center justify-center p-6">
//               <Star color="#3B82F6" />
//               <div className="text-[92px] font-medium font-inter text-blue-500 mb-4 leading-none">
//                 37%
//               </div>
//               <p className="text-gray-600 font-manrope text-[15px] text-center">
...
//             <div className="bg-white w-[285px] h-[273px] rounded-lg shadow-lg relative flex flex-col items-center justify-center p-6">
//               <Star color="#EC4899" />
//               <div className="text-[92px] font-medium font-inter text-pink-500 mb-4 leading-none">
//                 136
//               </div>
//               <p className="text-gray-600 font-manrope text-[15px] text-center">
//                 Keywords Ranked #1
...
//             <div className="bg-white w-[285px] h-[273px] rounded-lg shadow-lg relative flex flex-col items-center justify-center p-6">
//               <Star color="#EAB308" />
//               <div className="text-[92px] font-medium font-inter text-yellow-500 mb-4 leading-none">
//                 10
//               </div>
//               <p className="text-gray-600 font-manrope text-[15px] text-center">
...
//     <div 
//       className="w-full h-[35.36vw] max-h-[679px] min-h-[500px] bg-orange-50 relative overflow-hidden"
//       style={{
//         backgroundImage: statsbg, // Replace with your image path
