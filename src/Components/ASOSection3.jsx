      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative">
            {/* Blue accent strip */}
            <div className="absolute -top-6 left-0 w-full h-60 bg-[#dedcd1] transform -skew-x-1 -ml-6" />
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6 text-right">
                  <div>
                    ...
                    Target specific keywords to boost your app’s <br /> rankings and relevance.
                  ...
                  <div>
                    ...
                    <p className="text-[14px] text-gray-700">
                    Higher keyword rankings bring in more <br /> organic traffic over time.
          ...
          <div className="relative">
            {/* Teal accent strip */}
            <div className="absolute -top-6 right-0 w-full h-60 bg-[#8eafff] transform -skew-x-1 -mr-6" />
            
            <div className="relative bg-[#0f1934] p-8 lg:p-12 rounded-lg h-full">
              <div className="relative z-10">
                <h2 className="text-3xl lg:text-[56px] font-medium leading-[60px] text-white mb-12">
                5. Automated ASO <br /> <span className='lg:ml-72'>with AI</span> 
                </h2>
                
                <div className="mb-12">
                  <h3 className="text-[24px] font-medium text-white mb-4">Key Deliverables:</h3>
                ...
                <div className="space-y-6 text-right">
                  <div>
                    <h3 className="text-[24px] font-medium text-white mb-2">What We Do:</h3>
                  ...
                  <div>
                    <h3 className="text-[24px] font-medium text-white mb-2">Why It Matters:</h3>
