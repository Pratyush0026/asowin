...
//       <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-12 lg:px-20 py-8 md:py-12 flex flex-col lg:flex-row items-start gap-8 lg:gap-16">
//         {/* Left Section with Heading */}
//         <div className="lg:w-1/2 text-center lg:text-left">
//           <h1 className="text-[#FF6B00] text-3xl sm:text-4xl md:text-[40px] lg:text-5xl xl:text-6xl font-normal leading-[1.2] sm:leading-[1.2] md:leading-[1.2] lg:leading-[1.2] tracking-tight">
//             ASOWin's AI Agent:<br />
//             Revolutionizing App<br />
//             Store Optimization
//           </h1>
...
//         {/* Right Section with Description, Button, and Cards */}
//         <div className="lg:w-1/2 space-y-6 md:space-y-8 lg:space-y-10 flex flex-col">
//           {/* Paragraph */}
//           <div>
...
//               <div
//                 key={index}
//                 className="group bg-[#F5F7F9] rounded-lg p-6 md:p-8 border-2 border-transparent hover:border-[#FF6B00] hover:bg-white transition-all duration-300"
//               >
//                 <div className="mb-6 md:mb-8 text-gray-400 group-hover:text-[#FF6B00] transition-colors">
//                   <CubeIcon />
//                 </div>
//                 <div>
//                   <h3 className="text-base md:text-lg font-bold mb-3 md:mb-4">{feature.id}</h3>
