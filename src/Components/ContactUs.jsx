...
<div className="space-y-8">
  {/* Addresses */}
  <div>
    <p className="text-sm text-gray-600 font-medium mb-4">Company Addresses</p>
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-3">
        ...
        <p className="text-base text-gray-600">
          <span className="font-bold">Mumbai:</span> Office #3, Neelkanth, Next
          to Shreeji Heights, Sector 45A, Navi Mumbai, Maharashtra, India -
          400706
        </p>
      </div>
      {/* Noida Address */}
      <div className="flex items-start gap-3">
        ...
        <p className="text-base text-gray-600">
          <span className="font-bold">Noida:</span> Office #37, Tapasya Corp
          Heights, Sector 126, Noida, Uttar Pradesh - 201301
        </p>
      </div>
      {/* Delaware Address */}
      <div className="flex items-start gap-3">
        ...
        <p className="text-base text-gray-600">
          <span className="font-bold">Delaware:</span> 16192 Coastal Hwy, Lewes,
          DE 19958, USA
        </p>
      </div>
      {/* California Address */}
      <div className="flex items-start gap-3">
        ...
        <p className="text-base text-gray-600">
          <span className="font-bold">California:</span> 140 Black Mountain Cir,
