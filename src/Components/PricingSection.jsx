...
//                 <div className="absolute right-0 w-3
//                   h-[99%] top-2  bg-[#F37A60] translate-x-2
//                 " />
...
//               {/* Card Content */}
//               <div className="bg-white text-black p-8 h-full relative">
...
//                 <button className="w-full bg-teal-900 text-white py-3 text-center hover:bg-teal-800 transition-colors mt-16">
//                   LET'S TALK
//                 </button>
//               </div>
//             </div>
